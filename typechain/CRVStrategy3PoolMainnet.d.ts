...
interface CRVStrategy3PoolMainnetInterface extends ethers.utils.Interface {
  functions: {
    "controller()": FunctionFragment;
    "crv()": FunctionFragment;
    "curve()": FunctionFragment;
    "curve3PoolFromDai()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "curve3PoolFromDai",
    values?: undefined
  ): string;
...
export class CRVStrategy3PoolMainnet extends Contract {
  ...
  interface: CRVStrategy3PoolMainnetInterface;
  ...
  functions: {
    ...
    curve3PoolFromDai(overrides?: Overrides): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    curve3PoolFromDai(overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    curve3PoolFromDai(overrides?: Overrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    curve3PoolFromDai(overrides?: Overrides): Promise<PopulatedTransaction>;
