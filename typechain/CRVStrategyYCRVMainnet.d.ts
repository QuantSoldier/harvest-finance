...
interface CRVStrategyYCRVMainnetInterface extends ethers.utils.Interface {
  functions: {
...
export class CRVStrategyYCRVMainnet extends Contract {
  ...
  interface: CRVStrategyYCRVMainnetInterface;
