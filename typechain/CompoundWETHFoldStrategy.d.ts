...
interface CompoundWETHFoldStrategyInterface extends ethers.utils.Interface {
  functions: {
...
export class CompoundWETHFoldStrategy extends Contract {
  ...
  interface: CompoundWETHFoldStrategyInterface;
