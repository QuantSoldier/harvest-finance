...
interface DEGORewardInterfaceInterface extends ethers.utils.Interface {
  functions: {
    "balanceOf(address)": FunctionFragment;
    "earned(address)": FunctionFragment;
    "exit()": FunctionFragment;
    "getReward()": FunctionFragment;
    "stake(uint256,string)": FunctionFragment;
...
export class DEGORewardInterface extends Contract {
  ...
  interface: DEGORewardInterfaceInterface;
