...
interface IdleFinanceStrategyInterface extends ethers.utils.Interface {
  functions: {
...
export class IdleFinanceStrategy extends Contract {
  ...
  interface: IdleFinanceStrategyInterface;
