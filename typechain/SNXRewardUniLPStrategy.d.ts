...
interface SNXRewardUniLPStrategyInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setLiquidationPaths(address[],address[])": FunctionFragment;
    "setSell(bool)": FunctionFragment;
    "setSellFloor(uint256)": FunctionFragment;
    "setStorage(address)": FunctionFragment;
    "store()": FunctionFragment;
    "underlying()": FunctionFragment;
    "uniLPComponentToken0()": FunctionFragment;
    "uniLPComponentToken1()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "setLiquidationPaths",
  ...
  encodeFunctionData(
    functionFragment: "uniLPComponentToken0",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "uniLPComponentToken1",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class SNXRewardUniLPStrategy extends Contract {
  ...
  interface: SNXRewardUniLPStrategyInterface;
  ...
  functions: {
    ...
    "setLiquidationPaths(address[],address[])"(
      _uniswapRouteToToken0: string[],
      _uniswapRouteToToken1: string[],
      overrides?: Overrides
    ): Promise<ContractTransaction>;
    ...
    uniLPComponentToken0(overrides?: CallOverrides): Promise<[string]>;

    "uniLPComponentToken0()"(overrides?: CallOverrides): Promise<[string]>;

    uniLPComponentToken1(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    uniLPComponentToken0(overrides?: CallOverrides): Promise<BigNumber>;

    "uniLPComponentToken0()"(overrides?: CallOverrides): Promise<BigNumber>;

    uniLPComponentToken1(overrides?: CallOverrides): Promise<BigNumber>;
